...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean ActivateMenu_Left
        {
            get
            {
                return SteamVR_Actions.default_ActivateMenu_Left;
            }
        }
        
        public virtual SteamVR_Action_Boolean SelectMenu_Left
        {
            get
            {
                return SteamVR_Actions.default_SelectMenu_Left;
            }
        }
        
        public virtual SteamVR_Action_Vector2 MenuPosition_Left
        {
            get
            {
                return SteamVR_Actions.default_MenuPosition_Left;
            }
        }
        
        public virtual SteamVR_Action_Boolean ActivateMenu_Right
        {
            get
            {
                return SteamVR_Actions.default_ActivateMenu_Right;
            }
        }
        
        public virtual SteamVR_Action_Boolean SelectMenu_Right
        {
            get
            {
                return SteamVR_Actions.default_SelectMenu_Right;
            }
        }
        
        public virtual SteamVR_Action_Vector2 MenuPosition_Right
        {
            get
            {
                return SteamVR_Actions.default_MenuPosition_Right;
            }
        }
