...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Teleport : MonoBehaviour
    {
        ...
        public TeleportManager m_TeleportManager = null;
        ...
        private bool WasTeleportButtonReleased(Hand hand)
        {
            if (IsEligibleForTeleport(hand))
            {
                ...
                {
                    //Debug.Log("WasTeleportButtonReleased");
                    return m_TeleportManager.released;
        ...
        private bool IsTeleportButtonDown(Hand hand)
        {
            if (IsEligibleForTeleport(hand))
            {
                ...
                {
                    //Debug.Log("IsTeleportButtonDown");
                    return m_TeleportManager.state;
        ...
        private bool WasTeleportButtonPressed(Hand hand)
        {
            if (IsEligibleForTeleport(hand))
            {
                ...
                {
                   // Debug.Log("WasTeleportButtonPressed");
                    return m_TeleportManager.pressed;
