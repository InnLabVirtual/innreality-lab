...
namespace Valve.VR.Extras
{
    public class FrontCamera : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (!source.hasCamera) { 
                enabled = false;
                Debug.LogError("Custom: There is not Camera");
            }
        }
        ...
        private void Update()
        {
            ...
            transform.localScale = new Vector3(1, 1.0f / aspect, 1);
            ...
            if (source.hasTracking)
            {
                ...
                if (m_VRCamera)
                {
                    Quaternion customRot = m_VRCamera.gameObject.transform.localRotation;
                    transform.localRotation = customRot;
                }
                else { 
                    Quaternion customRot = rigidTransform.rot;
                    transform.localRotation = customRot;
                }
            }
